...
public class MyDslPackageImpl extends EPackageImpl implements MyDslPackage
{
   ...
   */
  @Override
  public EAttribute getDefinition_Value()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(definitionEClass, DEFINITION__VALUE);
  ...
  public void initializePackageContents()
  {
    ...
    additionEClass.getESuperTypes().add(this.getCommand());
    multiplicationEClass.getESuperTypes().add(this.getCommand());
    divisionEClass.getESuperTypes().add(this.getCommand());
    ...
    initEAttribute(getDefinition_Value(), ecorePackage.getEInt(), "value", null, 0, 1, Definition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
