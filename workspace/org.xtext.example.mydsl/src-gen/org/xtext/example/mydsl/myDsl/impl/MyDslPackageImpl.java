...
public class MyDslPackageImpl extends EPackageImpl implements MyDslPackage
{
   ...
   * @generated
   */
  public EAttribute getSubtraction_Name()
  {
   ...
   * @generated
   */
  public EAttribute getSubtraction_Value()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(subtractionEClass, SUBTRACTION__NAME);
    createEAttribute(subtractionEClass, SUBTRACTION__VALUE);
  }
  ...
  public void initializePackageContents()
  {
    ...
    subtractionEClass.getESuperTypes().add(this.getCommand());
    ...
    initEAttribute(getSubtraction_Name(), ecorePackage.getEString(), "name", null, 0, 1, Subtraction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getSubtraction_Value(), ecorePackage.getEInt(), "Value", null, 0, 1, Subtraction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
